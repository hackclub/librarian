...
module.exports = {
  ...
  render: async function ({ app, client }) {
    ...
    const sortedChannels = Object.keys(channelMap).sort(
      (a, b) => channelMap[b] - channelMap[a],
    ).slice(0, 10)
